...
PRINTER_CFG_PATH = os.path.join(IDEXCONFIG_PATH, "printer.cfg")
...
BACKUP_VARIABLES_PATH = os.path.join(IDEXCONFIG_PATH, "backups", "variables.cfg")
VARIABLES_PATH = os.path.join(IDEXCONFIG_PATH, "variables.cfg")